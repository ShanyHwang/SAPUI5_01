		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzui52415-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzui52415-display": {
								"semanticObject": "iitpzui52415",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zui52415",
									"url": sap.ui.require.toUrl("iitp/zui52415")
								}
							}
						}
					}
